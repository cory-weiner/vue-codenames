...
export default new Vuex.Store({
  ...
  mutations: {
    ...
    publishGameBoard(state) {
      state.client.publish(state.topic + state.lobby_id, JSON.stringify(state.gameboard), { qos: parseInt(state.publish_qos), retain: state.retain })
    },
    guess(state, index) {
    ...
    subscribeToBoard(state) {
      ...
      state.client.subscribe(state.topic + state.lobby_id, { qos: parseInt(state.subscribe_qos) })
    }
  },
  actions: {
  },
